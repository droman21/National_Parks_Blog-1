...
namespace National_Park_Blog
{
    public class NationalParkContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelbuilder)
        {
            ...
            new Blog_Content("Bob", "Bob Smith" ,1, "Not too far away, very relaxing, great park.", Convert.ToDateTime("06-18-2020"), 1),
            new Blog_Content("Dan", "Daniel Roman", 2, "Totally awesome, once in a lifetime experience", Convert.ToDateTime("06-18-2020"), 2),
            new Blog_Content("Chuck", "Chuck Robinson", 3, "Ran into many blockers during the trip, a bear raided my campsite", Convert.ToDateTime("06-18-2020"), 3),
            new Blog_Content("Dakota", "Dakota Whittle", 4, "I became one with Nature, 10/10 would recommend", Convert.ToDateTime("06-18-2020"), 4)
               );
